...
fs.readFile("themes/Nuclear-color-theme-light.json", "utf8", (err, content) => {
	const parsed = JSON5.parse(content);
	fs.writeFile(
		"themes/Nuclear-color-theme-light-minimized.json",
	...
	fs.writeFile(
		"themes/Nuclear-color-theme-light-no-bold-minimized.json",
		JSON.stringify(noBold),
		"utf8",
		() => {
